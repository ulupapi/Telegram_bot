...
- разделение интерфейсов:
  - пользовательский: только кнопки `Получить общую сводку`, `Режим редактирования`, `Помощь`;
...
- ручное добавление задачи: только кнопкой `Добавить задачу из ответа` (по reply на сообщение).
